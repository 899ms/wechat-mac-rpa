...
from wechat_rpa.logging.bot_logger import BotLogger
...
class TestBotLogger:
    ...
    def test_standard_log_methods(self, tmp_logs_dir, logger, caplog):
        with caplog.at_level(logging.DEBUG, logger="wechat_rpa.runtime"):
    ...
    def test_error_with_exc_info(self, tmp_logs_dir, logger, caplog):
        with caplog.at_level(logging.ERROR, logger="wechat_rpa.runtime"):
            try:
