...
import pytest
from wechat_rpa.models.base import Point, Rect, OCRTextElement, SenderType, ChatListItem
from wechat_rpa.layout.profile import LayoutProfile, PROFILE_WECHAT_MAC_1760X1280
