...
from wechat_rpa.capture.window_capture import (
...
class TestWindowCaptureRecovery(unittest.TestCase):
    ...
    @patch('wechat_rpa.capture.window_capture.subprocess.run')
    @patch('wechat_rpa.capture.window_capture.time.sleep')
    @patch('wechat_rpa.capture.window_capture.Quartz')
    @patch('wechat_rpa.capture.window_capture.AppKit')
