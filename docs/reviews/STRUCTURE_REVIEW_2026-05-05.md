...
**文件**: `wechat_rpa/bot/wechat_bot.py:101-363`
...
**文件**: `wechat_rpa/reply/generator.py:62-380`
**代码规模**: 317 行，27 个控制块
**影响**: 🔴 **极高**
...
**代码**: `from wechat_rpa.action.chat_list_clicker import ChatListClicker`
**影响**: 🟠 **高**
...
**文件**: `wechat_rpa/session/global_store.py:247-270`
**影响**: 🟠 **高**
...
**文件**: `wechat_rpa/session/global_store.py:174`
**代码**: `return sim >= 0.001`
**影响**: 🟠 **中-高**
...
**文件**: `wechat_rpa/bot/wechat_bot.py:306-317`
**代码**:
```python
...
**文件**: `wechat_rpa/reply/generator.py:293`
...
**文件**: `wechat_rpa/reply/generator.py:157-272`
**代码**:
```python
while True:
    raw = active_llm.chat(...)
...
**文件**: `wechat_rpa/bot/wechat_bot.py:111-354`
**代码**:
```python
try:
    # ... 260+ 行代码 ...
...
**文件**: `wechat_rpa/bot/wechat_bot.py:96`
...
**文件**: `wechat-mac-rpa/wechat_rpa/bot/wechat_bot.py:336-347`
...
**文件**: `wechat_rpa/reply/generator.py` 等

**结构性问题**: 混用 print 和 logging，导致日志输出不可控（print 无法设置级别、无法重定向）。

### LOW-2: 硬编码路径使用字符串拼接

**文件**: `wechat_rpa/storage/chat_history.py` 等
